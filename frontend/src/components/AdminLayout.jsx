...
import { LayoutDashboard, Users, CalendarClock, Settings as SettingsIcon, LogOut, Menu, X, Bell, User as UserIcon, ShieldAlert, Wrench, DollarSign, UsersRound } from 'lucide-react';
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 flex flex-col transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0`}
        ...
        <div className="h-16 flex items-center justify-between px-5" style={{ borderBottom: '1px solid #21262D' }}>
          <Link to="/admin" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center shadow-lg" style={{ background: 'linear-gradient(135deg, #FF6B00, #E55A00)' }}>
